...
public abstract class VacuumHarvesterBlockEntityMixin {
    ...
    private HarvestResult createintegratedfarming$sableHarvestAcrossLevels(
            AreaHarvestContext context, BlockPos center, int range, Operation<HarvestResult> original) {
        SubLevelAccess source = Sable.HELPER.getContaining((VacuumHarvesterBlockEntity) (Object) this);
        return SableVacuumHarvesting.harvestArea(
                context, center, range, source, () -> original.call(context, center, range));
    }
}
