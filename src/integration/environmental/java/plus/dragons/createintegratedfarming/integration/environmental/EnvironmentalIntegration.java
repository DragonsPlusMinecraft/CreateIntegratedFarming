...
package plus.dragons.createintegratedfarming.integration.environmental;
...
import plus.dragons.createintegratedfarming.integration.environmental.ponder.EnvironmentalPonderPlugin;
...
public class EnvironmentalIntegration {
    public EnvironmentalIntegration(IEventBus modBus) {
    ...
    public static class Common {
        ...
        public void construct(final FMLConstructModEvent event) {
            EnvironmentalBlocks.register(modBus);
            EnvironmentalBlockEntities.register(modBus);
        }
    ...
    public static class Client {
        @SubscribeEvent
        public void construct(final FMLConstructModEvent event) {
            EnvironmentalPonderPlugin.register();
        }
    }
}
