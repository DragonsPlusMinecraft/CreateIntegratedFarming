...
import plus.dragons.createintegratedfarming.integration.environmental.ranching.roost.EnvironmentalDuckRoostBlock;

public class EnvironmentalBlocks {
    public static final BlockEntry<EnvironmentalDuckRoostBlock> DUCK_ROOST = REGISTRATE
            .block("environmental_duck_roost", properties -> new EnvironmentalDuckRoostBlock(properties, ROOST))
            .lang("Duck Roost")
    ...
    public static void addToCreativeTab(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CIFCreativeModeTabs.BASE.getKey())
            event.accept(DUCK_ROOST);
    }

    public static void register(IEventBus modBus) {
        modBus.register(EnvironmentalBlocks.class);
    }
}
