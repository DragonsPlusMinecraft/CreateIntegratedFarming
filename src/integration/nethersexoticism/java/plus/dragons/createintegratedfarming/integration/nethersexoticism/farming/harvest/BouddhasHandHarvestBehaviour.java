...
public class BouddhasHandHarvestBehaviour implements CustomHarvestBehaviour {
    @Override
    ...
    private static @Nullable BlockState getFruit(Level level, BlockPos pos) {
        ...
        return state.is(NethersExoticismModBlocks.BOUDDHA_S_HAND_BLOCK.get()) ? state : null;
    }

    private static BlockState replacement(BlockState state) {
        return state.getValue(BouddhaSHandBlockBlock.WATERLOGGED)
